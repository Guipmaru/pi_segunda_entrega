...
//Declaração da classe database helper para gerenciar conexão com o banco de datos
...
//Função para inserir um novo usuário no banco de dados com username e senha como parâmetros
  Future<int> insertUser(String username, String password) async {
    final db = await database;
    return await db.insert('users', {'username': username, 'password': password});
  }
//Função para buscar o usuário com o username e password fornecidos, se não houver, retorna null
